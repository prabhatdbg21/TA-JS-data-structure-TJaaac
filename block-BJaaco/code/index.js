...
let collection = 0 ;
for (let eachCollection of userIds){
  collection = collection + eachCollection ;
} 
console.log (collection)

// 2. Add all the even numbers from both arrays numbers and userIds into a newly created array named `evenCollection`
let evenCollection = 0 ;
for (let eachCollection of numbers){
  if (eachCollection % 2 == 0){
    evenCollection = evenCollection + eachCollection ;
  }
}
for (let eachCollection of userIds){
  if (eachCollection % 2 == 0){
...
for (let eachCollection of numbers){
  if (eachCollection % 2 != 0){
    oddCollection = oddCollection + eachCollection ;
  }
}
for (let eachCollection of userIds){
  if (eachCollection % 2 != 0){
