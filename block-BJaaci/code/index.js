...
console.log (movies[movies.length - 2].genres[(movies[0].genres.length) - (movies[0].genres.length)])

// 18. Log all the genres of the first movie one by one
for (let first of movies[0].genres){
  console.log (first);
}
...
if (movies[0].title === "Hannah"){
  ...
  console.log ("not Hannah");
}

// 25. Log the number of actors in all three movies one by one
for ( let i = 0 ; i < movies.length  ; i++ ){
  console.log (`Number of actors in movie ${movies[i].actors.length}` )
  }

// 26. Log the number of genres in all three movies one by one
for ( let i = 0 ; i < movies.length  ; i++ ){
  console.log (`Number of genres in movie ${movies[i].genres.length}` )
  }
