...
character.greet = alert ( `I am ${character.characterName} and my title is ${character.title}`);       // D
...
alert (character.greet =  `She is ${character.characterName} and her title is ${character.title}`) //D
...
if (age > 18) {character.isAdult = "true"}
